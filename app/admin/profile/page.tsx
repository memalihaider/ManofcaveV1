...
import { User, Mail, Phone, MapPin, Calendar, Shield, Key, Upload, Save, Eye, EyeOff } from "lucide-react";
...
export default function AdminProfile() {
  ...
  const [profile, setProfile] = useState({
    ...
    bio: 'Branch administrator with 5+ years of experience managing premium barber shops.',
