...
export default function SuperAdminOrders() {
  ...
  // Mock orders data across multiple branches
  const orders: Order[] = [
    {
      id: '1',
  ...
  const getBranchStats = () => {
    ...
    return branches.map(branch => ({
      ...
      revenue: orders
        .filter(order => order.branch === branch && order.status !== 'cancelled' && order.paymentStatus === 'paid')
        .reduce((sum, order) => sum + order.total, 0)
    }));
  };
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Manage physical product orders across all branches</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <CurrencySwitcher />
                ...
                <TabsContent value="all">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Complete overview of all product orders across branches</CardDescription>
                    </CardHeader>
                    <CardContent>
                        ...
                        {filteredOrders.map((order) => (
                          <div key={order.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
                            <div className="flex items-center justify-between mb-4">
                              <div className="flex items-center gap-4">
                                <div>
                                  ...
                                  <Badge variant="outline" className="mt-1">{order.branch}</Badge>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                              ...
                              <div>
                                <span className="text-gray-600">Branch:</span> {order.branch}
                              </div>
                              <div>
                ...
                <TabsContent value="pending">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Orders waiting for confirmation across all branches</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
